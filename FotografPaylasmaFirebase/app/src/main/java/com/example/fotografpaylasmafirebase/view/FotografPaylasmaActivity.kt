...
class FotografPaylasmaActivity : AppCompatActivity() {
    private lateinit var tasarim : ActivityFotografPaylasmaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tasarim = ActivityFotografPaylasmaBinding.inflate(layoutInflater)
        ...
        if(secilenGorsel != null){
            ...
            gorselReference.putFile(secilenGorsel!!).addOnSuccessListener {
                ...
                yuklenenGorselReference.downloadUrl.addOnSuccessListener {
                    ...
                    val kullaniciYorumu = tasarim.yorumText.text.toString()
        ...
        if(requestCode == 2 && resultCode == Activity.RESULT_OK && data != null){
            ...
            if(secilenGorsel != null){
                ...
                if(Build.VERSION.SDK_INT >= 28){
                    ...
                    tasarim.imageView.setImageBitmap(secilenBitmap)
